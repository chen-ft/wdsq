					...
					<div class="aw-user-setting">
						<div class="tabbable">
							<ul class="nav nav-tabs aw-nav-tabs active">
								<h2><i class="icon icon-setting"></i></h2>
							</ul>
						</div>
									...
									<div class="mod-body">
										<div class="aw-mod aw-user-setting-bind">
											<div class="mod-head title-input">
												<textarea id="js-textarea" ui-textarea-autogrow="" required="" ng-model="draft.title" name="title" ui-tab-trigger="" autofocus="" word-min="2" word-max="50" placeholder="请输入标题" style="height: 46px;width: 912px;resize: none;"></textarea>
											</div>
											<div class="mod-body">
