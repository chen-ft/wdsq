                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="box box-danger">
                      ...
                      <div class="box-body">
                          <canvas id="pieChart" style="height: 403px; width: 806px;" width="806" height="403"></canvas>
                      </div><!-- /.box-body -->
                    </div><!-- /.box -->
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="box box-success">
                      ...
                      <div class="box-body">
                        <div class="chart">
                          <canvas id="barChart" style="height: 230px; width: 786px;" width="786" height="230"></canvas>
                        </div>
                      </div><!-- /.box-body -->
                    </div><!-- /.box -->
