<?php 
    try {
        ...
        while ( $row = $rs->fetch(PDO::FETCH_NUM)) {
            // $arrayJson = json_encode($row,true) ;
            $array  = $row;
        }
                                    ...
                                    <div class="box-body" style="margin-bottom: 40px;background: #fff;">
                                        ...
                                        <div id="myTabContent" class="tab-content">
                                            <div class="tab-pane fade in active" id="table">
                                                <input id="file-1" type="file" name="file1" multiple class="file1" data-overwrite-initial="false" data-min-file-count="2">
                                            </div>
                                            <div class="tab-pane fade" id="ID">
                                                <input id="file-2" type="file" name="file2" multiple class="file2" data-overwrite-initial="false" data-min-file-count="2">
                                            </div>
...
// cmdImgBankEdit cmdImgSocialEdit cmdImgSafeEdit cmdImgOtherEdit
    // 银行卡
    var j = 0,bankArr = [];
