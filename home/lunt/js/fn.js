...
AWS.User = 
{
  ...
  question_thanks(selector)
  {
        ...
        selector.attr('onclick','AWS.User.question_thanks_cancel($(this))').html('<i class="icon icon-thank" style="color:red"></i>取消感谢');
  },
  //取消赞
  question_thanks_cancel(selector)
  {
       selector.attr('onclick','AWS.User.question_thanks($(this))').html('<i class="icon icon-thank"></i>感谢');
  },
