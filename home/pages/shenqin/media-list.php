          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="apply-progress.php"><i class="fa fa-circle-o"></i> 进件进度查询(分公司)</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
                  ...
                  <table id="example1" class="table table-bordered table-covered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>李二倩</td>
                        <td>4516544454546545</td>
                        <td>消费金融</td>
                        <td>2016-09-12</td>
                        <td>终审拒绝/放款成功</td>
                        <td>
                        <a href="media-list-upload.php" class="btn btn-block btn-primary">上传</a>
                        </td>
                      </tr>
                      <tr>
                        <td>BB20161012450734</td>
                        ...
                        <td>终审拒绝/放款成功</td>
                        <td>
                        <a class="btn btn-block btn-primary">上传</a>
                        </td>
                      </tr>
                      <tr>
                        <td>BB20161012450734</td>
