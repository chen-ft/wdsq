          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="media-list.html"><i class="fa fa-circle-o"></i> 影像件管理</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> 面审签约</a></li>
                <li class="active"><a href="#"><i class="fa fa-circle-o"></i> 二次进件查询</a></li>
                  ...
                  <table id="example1" class="table table-bordered table-covered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>x厦门</td>
                        <td>否</td>
                        <td>2016-09-28 14：10：10</td>
                        <td>路明</td>
                        <td>审批通过</td>
                        <td>王伟</td>
                        <td>审批时间</td>
                        <td><a href="second-loan-detail.php">查看</a></td>
                      </tr>
                      <tr>
                        <td>王红柱</td>
                        <td>x厦门</td>
