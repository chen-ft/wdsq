          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="apply-progress.php"><i class="fa fa-circle-o"></i> 进件进度查询</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="../xinshen/xinshen.php"><i class="fa fa-circle-o"></i> 信审进度查询</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="../finance/accout.query.php"><i class="fa fa-circle-o"></i> 客户终审查询</a></li>
                <li><a href="../finance/faxi-message.php"><i class="fa fa-circle-o"></i> 客户罚息信息</a></li>
                <li><a href="../finance/sub-repayment.php"><i class="fa fa-circle-o"></i> 客户还款详情</a></li>
                <li><a href="../finance/sub-list.php"><i class="fa fa-circle-o"></i> 客户结清查询</a></li>
              </ul>
            </li>
             <li class="treeview">
              <a href="#">
            ...
            <div class="col-xs-12">
             <!-- 筛选 -->
              <form class="form-horizontal">
                <div class="box-body">
                   <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">申请件编号:</label>
                      <div class="col-sm-1 dataTables_filter" id="">
                        <input type="search" class="form-control input-sm" placeholder="" aria-controls="example1" id="">
                      </div>
                      <label for="inputEmail3" class="col-sm-1 control-label">所属分公司:</label>
                      <div class="col-sm-1 dataTables_filter" id="">
                        <input type="search" class="form-control input-sm" placeholder="" aria-controls="example1" id="">
                      </div>
                      <label for="inputEmail3" class="col-sm-1 control-label">业务员:</label>
                      <div class="col-sm-1 dataTables_filter" id="">
                        <input type="search" class="form-control input-sm" placeholder="" aria-controls="example1" id="">
                      </div>
                  </div>
                  <div class="form-group" >
                     <label for="inputEmail3" class="col-sm-2 control-label">客户名称:</label>
                      ...
                      <label for="inputEmail3" class="col-sm-1 control-label">客户身份证:</label>
                      <div class="col-sm-1 dataTables_filter" id="">
                        <input type="search" class="form-control input-sm" placeholder="" aria-controls="example1" id="">
                      </div>
                      <label for="inputEmail3" class="col-sm-1 control-label">产品:</label>
                      <div class="col-sm-1 dataTables_filter" id="">
                        <select name="" id="" class="form-control input-sm " style="margin-left: 5px;">
                          <option value="">产品A</option>
                          <option value="">产品B</option>
                        </select>
                      </div>
                  </div>
                  <div class="form-group" >
                     <label for="inputEmail3" class="col-sm-2 control-label">申请状态:</label>
                      <div class="col-sm-1 dataTables_filter" id="">
                        <input type="search" class="form-control input-sm" placeholder="" aria-controls="example1" id="" disabled>
                      </div>
                      <label for="inputEmail3" class="col-sm-1 control-label">业务员:</label>
                      <div class="col-sm-1 dataTables_filter" id="">
                        <input type="search" class="form-control input-sm" placeholder="" aria-controls="example1" id="" disabled>
                      </div>
                      <label for="inputEmail3" class="col-sm-1 control-label">客服:</label>
                      <div class="col-sm-1 dataTables_filter" id="">
                        <input type="search" class="form-control input-sm" placeholder="" aria-controls="example1" id="" disabled>
                      </div>
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-covered">
                    <thead>
                      <tr>
                        <th>申请件编号</th>
                        <th>客户姓名</th>
