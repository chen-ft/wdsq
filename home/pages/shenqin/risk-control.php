          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li  class="active"><a href="risk-control.php"><i class="fa fa-circle-o"></i> 风控审核管理</a></li>
          ...
          <div class="row">
           <!-- 右边列表 -->
            <div style="margin:0 30px;">
                ...
                <div class="box-body">
                  <form class="form-horizontal">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        <div class="col-sm-11">
                         <button style="float:right" class="btn btn-primary">保存</button>
                        </div>
                      </div>
                    </div><!-- /.box-body -->
                  </form>
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title"> 第三方资信 </h3>
                </div><!-- /.box-header -->
                  <form class="form-horizontal">
                   <div class="box-body">
                      <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">第三方结果:</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" value="待处理">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="inputEmail3" class="col-sm-2 control-label">第三方备注:</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="" value="该客户有逾期，暂定放款">
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="col-sm-11">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title"> 风控审核区 </h3>
                </div><!-- /.box-header -->
                  <form class="form-horizontal">
                   <div class="box-body">
                      <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">风控结果:</label>
                        <div class="col-sm-3">
                      ...
                      <div class="form-group">
                        <label for="inputEmail3" class="col-sm-2 control-label">风控备注:</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="" value="经核实该客户还款信息良好">
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="col-sm-11">
