          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li><a href="client-list.html"><i class="fa fa-circle-o"></i> 客户信息录入</a></li>
                <li><a href="apply-message-list.html"><i class="fa fa-circle-o"></i> 申请信息录入</a></li>
                <li class="active"><a href="media-list.html"><i class="fa fa-circle-o"></i> 影像件管理</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> 面审签约</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> 二次进件查询</a></li>
                <li><a href="apply-progress.html"><i class="fa fa-circle-o"></i> 申请进度查询(分公司)</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="../xinshen/xinshen.html"><i class="fa fa-circle-o"></i> 申请进件查询</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="../finance/accout.query.html"><i class="fa fa-circle-o"></i> 账户查询(终审)</a></li>
                <li><a href="../finance/faxi-message.html"><i class="fa fa-circle-o"></i> 罚息信息管理</a></li>
                <li><a href="../finance/sub-repayment.html"><i class="fa fa-circle-o"></i> 分公司人工还款</a></li>
                <li><a href="../finance/sub-list.html"><i class="fa fa-circle-o"></i> 分公司结清列表</a></li>
              </ul>
            </li>
          </ul>
        </section>
                  ...
                  <form class="form-horizontal">
                    <div class="box-body">
                      ...
                      <label for="inputEmail3" class="col-sm-2 control-label">身份证:</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="inputEmail3" value="3502340124912014" disabled>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="inputEmail3" class="col-sm-2 control-label">姓名:</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control " id="inputEmail3" value="徐巧茹" disabled>
                        </div>
                        <label for="inputEmail3" class="col-sm-1 control-label">性别:</label>
                        <div class="col-sm-2">
                          <input type="text" class="form-control" id="inputEmail3" value="男" disabled>
                        </div>
                      </div>
                      <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">手机号1:</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="inputEmail3" value="徐巧茹" disabled>
                        </div>
                        <label for="inputEmail3" class="col-sm-1 control-label">手机号2:</label>
                        <div class="col-sm-2">
                          <input type="text" class="form-control" id="inputEmail3" value="18188775614" disabled>
                        </div>
                        <label for="inputEmail3" class="col-sm-1 control-label">出身日期:</label>
                        <div class="col-sm-2">
                          <input type="text" class="form-control" id="inputEmail3" value="配偶" disabled>
                        </div>
                      </div>
                    </div><!-- /.box-body -->
                  </form>
                ...
                <form class="form-horizontal">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-3">
                        <input type="text" class="form-control" id="inputEmail3" value="刘家秀" disabled>
                      </div>
                      <label for="inputEmail3" class="col-sm-1 control-label">电话:</label>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="inputEmail3" value="14588775614" disabled>
                      </div>
                      <label for="inputEmail3" class="col-sm-1 control-label">关系:</label>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="inputEmail3" value="母子(女)" disabled>
                      </div>
                    </div>
                     <!-- 进件原因 -->
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label"><s style="text-decoration: none;color: red">*</s>进件原因</label>
                      <div class="col-sm-9">
                        <textarea class="form-control" rows="5" disabled>客户要求额度6000</textarea>
                      </div>  
                    </div> <!-- 进件原因 -->
                    <div style="border:1px dotted #ccc;margin:10px 0;"></div>
                    <div class="form-group">
                    ...
                    <!-- 审核意见 -->
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label"><s style="text-decoration: none;color: red">*</s>审核意见</label>
                      <div class="col-sm-9">
                        <textarea class="form-control" rows="5" disabled>通过</textarea>
                      </div>  
                    </div> <!-- 审核意见 -->
                  </div><!-- /.box-body -->
                </form>
