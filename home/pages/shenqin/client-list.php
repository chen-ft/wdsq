              ...
              <form class="form-horizontal">
                <div class="box-body">
                  <div class="form-group">
                        ...
                        <div class="col-sm-2">
                           <input type="search" class="form-control input-sm apply_filter" id="apply0_Num" name="apply0_Num" onblur="search()">
                        </div>
                        <label for="inputEmail3" class="col-sm-1 control-label">客户名称:</label>
                        <div class="col-sm-2">
                          <input type="search" class="form-control input-sm apply_filter" id="apply1_Num" name="apply1_Num" onblur="search()">
                        </div>
                        <label for="inputEmail3" class="col-sm-1 control-label">所属分公司:</label>
                        <div class="col-sm-2">
                          <input type="search" class="form-control input-sm apply_filter" id="apply2_Num" name="apply2_Num" onblur="search()">
                        </div>
                        <label for="inputEmail3" class="col-sm-1 control-label"></label>
                        <a href="client-add.php" class="btn btn-primary btn-sm">添加用户</a>
                      </div>
                </div><!-- /.box-body -->
              </form><!-- 筛选 -->
              <div class="box">
    ...
    <script>
       ...
       var client_table =  $('#client_table').dataTable({
          ...
          "ajax":{
                  "url":"search.php",
                  "data":{
                    'data_num':$('#apply0_Num').val(),
                    'data_client':$('#apply1_Num').val(),
                    'data_company':$('#apply2_Num').val(),
                  },
      },
        });
       ...
       function search(){
         var params = {
          ...
          client_table.api().settings()[0].ajax.data = params;
          client_table.api().ajax.reload();
