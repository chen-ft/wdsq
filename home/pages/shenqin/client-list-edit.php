  ...
  <body class="hold-transition skin-blue sidebar-mini">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="/jjtong/admin.php?module=index&action=client_list"><i class="fa fa-circle-o"></i> 客户信息管理</a></li>
    ...
    <script>
      $(document).ready(function(){
        $.ajax({
            type:'post',
            data: {cmd:'cmdUserLogin'},
            url : '/jjtong/admin.php?module=index&action=data',
            dataType: 'json',
