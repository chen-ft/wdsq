              ...
              <form class="form-horizontal">
                <div class="box-body">
                  <div class="form-group">
                        ...
                        <div class="col-sm-2">
                           <input type="search" class="form-control input-sm apply_filter" id="#" name="#" onblur="search()">
                        </div>
                        <label for="inputEmail3" class="col-sm-1 control-label">客户名称:</label>
                        <div class="col-sm-2">
                          <input type="search" class="form-control input-sm apply_filter" id="#" name="#" onblur="search()">
                        </div>
                        <label for="inputEmail3" class="col-sm-1 control-label">录件开始时间:</label>
                        <div class="col-sm-2">
                          <input type="search" class="form-control input-sm apply_filter" id="#" name="#" onblur="search()">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="inputEmail3" class="col-sm-2 control-label">客户身份证:</label>
                        <div class="col-sm-2">
                           <input type="search" class="form-control input-sm apply_filter" id="#" name="#" onblur="search()">
                        </div>
                        <label for="inputEmail3" class="col-sm-1 control-label">申请产品:</label>
                        <div class="col-sm-2">
                          <input type="search" class="form-control input-sm apply_filter" id="#" name="#" onblur="search()">
                        </div>
                        <label for="inputEmail3" class="col-sm-1 control-label">录件开始时间:</label>
                  ...
                  <table id="example1" class="table table-bordered table-covered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>终审拒绝</td>
                        <td>
                          <a class="btn btn-block btn-primary" href="apply-message-list-edit.php">调阅</a>
                        </td>
                      </tr>
                        <tr>
                        <td>BB20161012450734</td>
