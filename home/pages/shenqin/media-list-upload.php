          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="media-list.php"><i class="fa fa-circle-o"></i> 影像件管理</a></li>
                ...
                <form class="form-8orizontal" >
                  <div class="box-body" style="margin-bottom: 40px;background: #fff;">
                    ...
                    <div class="cont1">
                      ...
                      <input id="tab8" class="input1" type="radio" name="tabs">
                      <label for="tab8"  class="label1">第三方协议</label>

                      <input id="tab9" class="input1" type="radio" name="tabs">
                      <label for="tab9"  class="label1">借款承诺书</label>

                      <input id="tab10" class="input1" type="radio" name="tabs">
                      <label for="tab10"  class="label1">还款明细</label>

                      <input id="tab11" class="input1" type="radio" name="tabs">
                      <label for="tab11"  class="label1">信用咨询管理服务协议</label>

                      <input id="tab12" class="input1" type="radio" name="tabs">
                      <label for="tab12"  class="label1">委托扣款协议书与POS条款</label>

                      <input id="tab13" class="input1" type="radio" name="tabs">
                      <label for="tab13"  class="label1">其他(NFC版权属，签约照片等)</label>
                      ...
                      <section id="content8" class="section1">
                        <h3>Here Are Many Words</h3>
                        <p>7</p>
                      </section>
                      <section id="content9" class="section1">
                        <h3>Here Are Many Words</h3>
                        <p>7</p>
                      </section>
                      <section id="content10" class="section1">
                        <h3>Here Are Many Words</h3>
                        <p>7</p>
                      </section>
                      <section id="content11" class="section1">
                        <h3>Here Are Many Words</h3>
                        <p>7</p>
                      </section>
                      <section id="content12" class="section1">
                        <h3>Here Are Many Words</h3>
                        <p>7</p>
                      </section>
                      <section id="content13" class="section1">
                        <h3>Here Are Many Words</h3>
                        <p>7</p>
                      </section>
